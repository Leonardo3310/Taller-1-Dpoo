...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país que representa el atleta");
	...
	/**
	 * Este metódo sirve para imprimir el nombre del atleta y el pais
	 * que representa, pidiendole el nombre al usuario.
	 * 
	 * @param ninguno, input interno para funciones de procesamiento.
	 * @return ninguna, impresión de los resultados.
	 */
	private void ejecutarPaisxAtleta()
	{
		System.out.println("\n" + "País por atleta");
